...
[rewrite_local]
> 哔哩哔哩大会员
^http[s]?://((app|api).(\w{2,15})?.(com|cn|net|org)).(playconf|player|reply).(v3|v2|v1).(ViewP|Reply|Play(URL|View|Conf)).$ url script-request-header https://Ansned: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@raw.githubusercontent.com/Ansned/use-self/main/Script/Bilibili/bli.js
[mitm]
